...
### - CNNStrategy, strategy_type=equaldollar
echo "Running Testback.py CNNStrategy,strategy_type=equalpositive"
python Testback.py CNNStrategy,strategy_type=equalpositive
