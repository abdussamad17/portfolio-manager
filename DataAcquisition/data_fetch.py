...
class DataFetcher:
    def __init__(self):
        ...
        self.storage_folder = os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'RawDataStorage')
    ...
    def fetch_full_historical_price(self, symbol):
        data = self._get_data(f'/api/v3/historical-price-full/{symbol}?apikey=')
